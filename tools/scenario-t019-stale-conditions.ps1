...
'@ -TimeoutSec 30
    ...
    Check ($after -match 'entries=13 ')              'the list has exactly this version''s conditions'
    ...
    Check ($unknown -match 'set_ok=true entries=13')  'set() of an unknown code neither throws nor adds'
}
finally {
    Stop-Game
}
