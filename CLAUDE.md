...
| Run a sweep, or deep-dive a class, on the slot harness | [docs/runbook-sweeps.md](docs/runbook-sweeps.md) -- the machine caps live there; architecture and why in [docs/design-remote-harness.md](docs/design-remote-harness.md) |
